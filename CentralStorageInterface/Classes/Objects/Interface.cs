...
public class Interface
{
    ...
    public static void OpenInterface(SObject interfaceObject, IMonitor monitor)
    {
        ...
        Interface_Menu testMenu = new Interface_Menu(monitor, (int)center.X, (int)center.Y, 800 + IClickableMenu.borderWidth * 2, 600 + IClickableMenu.borderWidth * 2, true);
